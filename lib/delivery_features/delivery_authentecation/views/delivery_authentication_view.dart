...
import '../../../admin_features/admin_main_layout/views/admin_main_layout.dart';




class DeliveryAuthenticationView extends StatelessWidget {
  const DeliveryAuthenticationView({super.key});


  static String id = "DeliveryAuthenticationView";
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              GlobalButtonWidget(
                ...
                text: "متابعة",
                onTap: () {
                  Navigator.pushReplacementNamed(context, DeliveryMainLayoutView.id);
                },
              ),
