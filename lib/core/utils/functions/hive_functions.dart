...
void saveProductsData({required List<HomeShopProductEntity> products, required String boxName}) {
  var box = Hive.box<HomeShopProductEntity>(boxName);
  box.addAll(products);
}

void saveDeliveriesData({required List<DeliveryEntity> deliveries, required String boxName}) {
