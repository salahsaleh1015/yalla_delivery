...
void serviceLocatorSetup() {
  ...
  getIt.registerSingleton<FireStoreFeedBackServices>(
      FireStoreFeedBackServices());
  ...
  getIt.registerSingleton<HomeRepoImpl>(
    HomeRepoImpl(
      ...
      homeRemoteDataSource:
          HomeRemoteDataSourceImpl(getIt.get<FirestoreHomeServices>()),
    ),
  );

  getIt
      .registerSingleton<DeliveryManagementRepoImpl>(DeliveryManagementRepoImpl(
    deliveryManagementLocalDataSource: DeliveryManagementLocalDataSourceImpl(),
    deliveryManagementRemoteDataSources:
        DeliveryManagementRemoteDataSourcesImpl(
