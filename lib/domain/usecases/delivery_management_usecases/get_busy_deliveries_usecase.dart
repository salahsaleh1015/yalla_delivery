...
class GetBusyDeliveriesUseCase extends UseCase<List<DeliveryEntity>, String> {
  DeliveryManagementRepo deliveryManagementRepos;

  GetBusyDeliveriesUseCase(this.deliveryManagementRepos);

  @override
  Future<Either<Failure, List<DeliveryEntity>>> call(String param) async {
    return await deliveryManagementRepos.getBusyDeliveries(status: param);
  }
}