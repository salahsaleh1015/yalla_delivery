...
class _$CachedUserModelImpl implements _CachedUserModel {
  ...
  @override
  String toString() {
    return 'CachedUserModel(userLocation: $userLocation, userName: $userName, phoneNumber: $phoneNumber, userId: $userId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userLocation, userName, phoneNumber, userId);
...
abstract class _CachedUserModel implements CachedUserModel {
  const factory _CachedUserModel(
      ...
      @HiveField(3) final String? userId}) = _$CachedUserModelImpl;
