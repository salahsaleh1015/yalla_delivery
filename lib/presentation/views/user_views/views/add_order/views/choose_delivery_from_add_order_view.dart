...
class ChooseDeliveryFromAddOrderView extends StatefulWidget {
  ChooseDeliveryFromAddOrderView({super.key, required this.order});

  final String order;

  @override
  State<ChooseDeliveryFromAddOrderView> createState() =>
      _ChooseDeliveryFromAddOrderViewState();
}

class _ChooseDeliveryFromAddOrderViewState
    extends State<ChooseDeliveryFromAddOrderView> {
...
class ChooseDeliveryFromShopView extends StatefulWidget {
  const ChooseDeliveryFromShopView(
      {super.key, required this.shopOrderBodyModel});
  final ShopOrderBodyModel shopOrderBodyModel;
  @override
  State<ChooseDeliveryFromShopView> createState() =>
      _ChooseDeliveryFromShopViewState();
}

class _ChooseDeliveryFromShopViewState
    extends State<ChooseDeliveryFromShopView> {
  late DeliveryModel selectedDelivery;
          ...
          child: GlobalButtonWidget(
            ...
            onTap: () {
              Navigator.pushNamed(context, Routes.orderSummaryRoute,
                  arguments: OrderInfoModel(
                    deliveryModel: selectedDelivery,
                    order: widget.shopOrderBodyModel.products,
                  ));
            },
            width: double.infinity,
          ),
