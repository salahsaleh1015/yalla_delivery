...
import 'package:delivery_app/presentation/features/views/cart/views/cart_order_summary_view.dart';
...
import 'package:delivery_app/presentation/global_widgets/lists/global_delivery_cards_for_shop_list_widget.dart';
...
class CartChooseDelivery extends StatelessWidget {
  const CartChooseDelivery({super.key});
  static String id = "CartChooseDelivery";
  @override
